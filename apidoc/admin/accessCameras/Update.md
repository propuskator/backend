# Update access camera

## Request
    PATCH /api/v1/admin/access-cameras/:id
...
```JSON5
{
    "name": "name",// optional, camera name
    "rtspUrl": "rtspUrl",// requioptionalred, camera url
...
```JSON5
{
    ...
    "data": {
        ...
        "lastAttemptAt": "2021-10-11T09:58:13.040Z",
        "updatedAt": "2021-10-11T09:58:57.797Z",
        "accessTokenReaders": [
            {
                "id": "1633865346690059",
                "code": "code1234",
